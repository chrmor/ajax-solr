  ...
  $(function () {
    ...
    */
    ...
    Manager.addWidget(new AjaxSolr.AutocompleteWidget({
      id: 'dbp_text',
      target: '#dbp_search',
      fields: ['Source_s','Thing_ss','Website_ss','TradeUnion_ss','Scientist_ss','ProgrammingLanguage_ss','PoliticalParty_ss','Newspaper_ss','MusicalArtist_ss','MusicGenre_ss','MilitaryUnit_ss','MilitaryConflict_ss','Film_ss','Event_ss','EthnicGroup_ss','CelestialBody_ss','Band_ss','Award_ss','AdministrativeRegion_ss','AcademicJournal_ss','WorldHeritageSite_ss','Software_ss','Non-ProfitOrganisation_ss','Magazine_ss','City_ss','Artist_ss','WrittenWork_ss','PeriodicalLiterature_ss','GovernmentAgency_ss','President_ss','Politician_ss','Settlement_ss','OfficeHolder_ss','Company_ss','Disease_ss','Work_ss','University_ss','EducationalInstitution_ss','Person_ss','Country_ss','PopulatedPlace_ss','Place_ss','Organisation_ss'/*auto-facets-autocomplete-here*/],
      facetsNamesMapping: facetsNamesMapping,
      submitOnlyIfTermSelect: true
    }));
    ...
    var params = {
      facet: true,
      'facet.field': ['Source_s','Thing_ss','Website_ss','TradeUnion_ss','Scientist_ss','ProgrammingLanguage_ss','PoliticalParty_ss','Newspaper_ss','MusicalArtist_ss','MusicGenre_ss','MilitaryUnit_ss','MilitaryConflict_ss','Film_ss','Event_ss','EthnicGroup_ss','CelestialBody_ss','Band_ss','Award_ss','AdministrativeRegion_ss','AcademicJournal_ss','WorldHeritageSite_ss','Software_ss','Non-ProfitOrganisation_ss','Magazine_ss','City_ss','Artist_ss','WrittenWork_ss','PeriodicalLiterature_ss','GovernmentAgency_ss','President_ss','Politician_ss','Settlement_ss','OfficeHolder_ss','Company_ss','Disease_ss','Work_ss','University_ss','EducationalInstitution_ss','Person_ss','Country_ss','PopulatedPlace_ss','Place_ss','Organisation_ss'/*auto-facets-request-here*/],
      'facet.limit': 1000,
      'facet.mincount': 1,
      'sort': 'id desc',
      'json.nl': 'map'
