...
AjaxSolr.ResultWidget = AjaxSolr.AbstractWidget.extend({
  ...
  template: function (doc) {
    ...
    snippet += '<div class="text-right"><a href="' + doc.id +'">Go to the original page</a> - <a href="https://dandelion.eu/semantic-text/entity-extraction-demo/?text=' + doc.id + '&lang=auto&min_confidence=0.8&exec=true#results" target="_blank">See annotations</strong></a></div>';
    var output = "";
    if (doc.title_s != null && doc.title_s!='') {
         output += '<div><h4><em>' + doc.title_s + '<em><br/><small>' + doc.date_s + '</small></h4>';
    } else {
