...
AjaxSolr.ResultWidget = AjaxSolr.AbstractWidget.extend({
  ...
  template: function (doc) {
    ...
    snippet += '<div class="small text-right"><a href="' + doc.uri_ss[0] + '" target="_blank">See in <strong>GramsciSource.org</strong></a> - <a href="http://feed.thepund.it/?url=' + doc.uri_ss[0] +'.rdf&conf=timeline-demo.js"  target="_blank">Annotate with Pundit</a></divs>';
    var output = "";
